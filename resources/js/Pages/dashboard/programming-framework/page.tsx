...
interface Props {
    frameworks: Framework[]; // Array of Programming yang diterima dari controller
}

export default function Dashboard({ frameworks }: Props) {
        ...
        if (editingId) {
            ...
            router.put(`/dashboard/framework/${editingId}`, formData, {
                onSuccess: () => {
                    ...
                    toast.success('Berhasil Edit Programming Framework'); // Tampilkan notifikasi
                },
            });
        } else {
            ...
            router.post('/dashboard/framework', formData, {
                onSuccess: () => {
                    setIsOpen(false);
                    setFormData({ name: '' });
                    toast.success('Berhasil Tambah Programming Framework Baru');
                },
            });
        }
    };
    ...
    const openModal = (framework: Framework | null = null) => {
        if (framework) {
            ...
            setFormData({ name: framework.name });
        } else {
        ...
        if (deletingId) {
            router.delete(`/dashboard/framework/${deletingId}`, {
                onSuccess: () => {
                    ...
                    toast.success('Berhasil Hapus Framework Language');
                },
            });
        }
    };
    ...
    return (
        <AuthenticatedLayout
            breadcrumb={[
                { name: 'Framework Language', url: '/dashboard/framework' },
            ]}
        >
            <Head title="Framework Language" />
                                    ...
                                    <DialogContent>
                                        ...
                                        >
                                            <Input
                                                ...
                                                placeholder="Enter framework language name"
                                            />
                                ...
                                <DialogContent>
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            ...
                                            framework language? This action
                                            cannot be undone.
                                        </DialogDescription>
                                    </DialogHeader>
